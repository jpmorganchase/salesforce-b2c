...
var JpmcOrderModel = require('../../mocks/jpmcModelsMocks/jpmcOrderModelMock.test');
var JpmcPaymentInstrumentModel = require('../../mocks/jpmcModelsMocks/jpmcPaymentInstrumentModelMock.test');
var JpmcCardholderVerificationModel = require('../../mocks/jpmcModelsMocks/jpmcCardholderVerificationModelMock.test');
var JpmcAVSModel = require('../../mocks/jpmcModelsMocks/jpmcAVSModelMock.test');
var JpmcPageEncryptionModel = require('../../mocks/jpmcModelsMocks/jpmcPageEncryptionModelMock.test');
var JpmcAdditionalAuthInfoModel = require('./jpmcAdditionalAuthInfoModelMock.test');
var profileAddModel = require('../../mocks/jpmcModelsMocks/jpmcProfileAddModelMock.test');
var JPMCOProfileServices = require('../../mocks/jpmcOServicesMocks.test');
var tokenModel = require('../../mocks/jpmcModelsMocks/jpmcTokenModelMock.test');
var JPMCOTokenServices = require('../../mocks/jpmcOServicesMocks.test');
...
PaymentModel.getPaymentObjectForCardAuthorizationOnly = function (order, card, paymentMethod) {
    ...
    if (card.cardType.value === JPMCOrbitalConstants.GOOGLE || order.paymentInstrument.creditCardType === JPMCOrbitalConstants.VISA_CHECKOUT || order.paymentInstrument.creditCardType === JPMCOrbitalConstants.APPLE) {
...
PaymentModel.getPaymentObjectForCardAuthorizationAndCapture = function (order, card, paymentMethod) {
    ...
    if (order.paymentInstrument.creditCardType === JPMCOrbitalConstants.GOOGLE || order.paymentInstrument.creditCardType === JPMCOrbitalConstants.VISA_CHECKOUT || order.paymentInstrument.creditCardType === JPMCOrbitalConstants.APPLE) {
        PaymentInstrumentModel.card.cardBrand = order.paymentInstrument.custom.jpmco_cardBrand;
        PaymentInstrumentModel.card.tokenTxnType = JPMCOrbitalConstants.UT;
        PaymentInstrumentModel.customerAccountType = JPMCOrbitalConstants.CC;
    }
